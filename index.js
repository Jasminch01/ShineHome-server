...
async function run() {
  try {
    ...
    app.post("/quoteInfo", async (req, res) => {
      ...
      const emailTemplate1 = `<!DOCTYPE html>
...
`;
                                      ...
                                      <td class="pad">
                                        ...
                                        >
                                          <p
                                            style="margin: 0; word-break: break-word"
                                          >
                                            <span>Quote Requester :${quoteInfo.to_name}</span> <br/>
                                        </p>
                                        <p style="font-size: 16px;">Quote Requested Date : ${quoteInfo.requestedDate}</p>
                                        <p style="font-size: 16px;">Email Address : ${quoteInfo.to_email[0]}</p>
                                        <p style="font-size: 16px; font-family: monospace;">Phone : ${quoteInfo.phone}</p>
                                        </div>
                                      </td>
                                    </tr>
                                  </table>
                                      ...
                                      <td class="pad">
                                        ...
                                        >
                                          <p
                                            style="margin: 0; word-break: break-word"
                                          >
                                          🎉Congratulations on successfully obtaining the quote information!!
                                          </p>
                                        </div>
                                      </td>
                                    </tr>
            ...
            <tr>
              <td class="pad">
                <div
                  ...
                  style="line-height: 10px"
                >
                  <div style="max-width: 136px; margin-bottom: 200px;">
                    <img
                      alt="Separator"
                      src="https://i.ibb.co/Y2WBQNz/separator.png"
                      style="
      ...
      const sendMailPromise2 = new Promise((resolve, reject) => {
        const mailOptions2 = {
          from: quoteInfo.form_email,
          to: quoteInfo.to_email[1], // Second recipient ozshineCleaners
          subject: quoteInfo.subject,
          html: emailTemplate2,
          replyTo: quoteInfo.form_email,
        };
